...
Ekin = 6.e9*qe              #6Gev in J
m0   = mp                   #mass of projectile
Z1   = 1                    #nuclear charge of projectile
EB   = 75*qe                #75 eV in J, i.e., average ionization energy of water

# Electron density  and mean exitation potential part
rho= 997e3                  #density in g/m^3
Z= 7.42                     #atomic number (effective) for water
A=18                        #mass number (in g/mol)
